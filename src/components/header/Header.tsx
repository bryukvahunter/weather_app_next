...
export default function Header() {
  return (
    <header className="flex w-full max-w-7xl flex-wrap items-center justify-center gap-4 rounded-2xl bg-white/10 px-6 py-4 text-white shadow-md backdrop-blur-sm sm:flex-nowrap sm:justify-between">
      <Logo />
      <Search />
      <NowDate />
      <ThemeChanger />
